...
- Utilizar Amazon SES para envios em produção; (Simple email service)
- O envio de e-mails deve acontecer em segundo plano (Background job)

**RN**

- O link enviado por email para resetar senha, deve expirar em 2h;
- O usuário precisa confirmar sua senha após a resetar;
...
- A notificação deve ter um status de lidar ou não lida para que o prestador passa controlar;
